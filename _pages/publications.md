...
<div class="col-sm-6 clearfix">
 ...
 <div class="well">
  ...
  <img src="{{ site.url }}{{ site.baseurl }}/images/pubpic/{{ publi.image }}" class="img-responsive" style="height: 300px; width: auto; object-fit: contain; margin: 10px auto; padding: 18px; display: block;" />
